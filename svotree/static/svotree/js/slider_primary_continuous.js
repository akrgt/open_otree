...
update_displayed_values('item7', item6_slider.getValue() / continuous_final_number);
update_displayed_values('item8', item6_slider.getValue() / continuous_final_number);
update_displayed_values('item9', item6_slider.getValue() / continuous_final_number);
update_displayed_values('item10', item6_slider.getValue() / continuous_final_number);
