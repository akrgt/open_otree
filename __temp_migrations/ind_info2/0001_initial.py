    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ind_info2_group', to='otree.Session')),
            ],
            options={
                'db_table': 'ind_info2_group',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crt_shk1', otree.db.models.StringField(choices=[('あてはまらない', 'あてはまらない'), ('どちらかといえばあてはまらない', 'どちらかといえばあてはまらない'), ('どちらかといえばあてはまる', 'どちらかといえばあてはまる'), ('あてはまる', 'あてはまる')], max_length=10000, null=True, verbose_name='宗教についておききしたいのですが，たとえば，あなたは，何か信仰とか信心とかを持っていますか？')),
                ('crt_shk2', otree.db.models.StringField(choices=[('あてはまらない', 'あてはまらない'), ('どちらかといえばあてはまらない', 'どちらかといえばあてはまらない'), ('どちらかといえばあてはまる', 'どちらかといえばあてはまる'), ('あてはまる', 'あてはまる')], max_length=10000, null=True, verbose_name='それでは，いままでの宗教にはかかわりなく，「宗教的な心」というものを，大切だと思いますか，それとも大切だとは思いませんか？')),
                ('crt_shk3', otree.db.models.StringField(choices=[('あてはまらない', 'あてはまらない'), ('どちらかといえばあてはまらない', 'どちらかといえばあてはまらない'), ('どちらかといえばあてはまる', 'どちらかといえばあてはまる'), ('あてはまる', 'あてはまる')], max_length=10000, null=True, verbose_name='何かの大きな力に自分の運命は動かされているように感じることがある.')),
                ('crt_shk4', otree.db.models.StringField(choices=[('あてはまらない', 'あてはまらない'), ('どちらかといえばあてはまらない', 'どちらかといえばあてはまらない'), ('どちらかといえばあてはまる', 'どちらかといえばあてはまる'), ('あてはまる', 'あてはまる')], max_length=10000, null=True, verbose_name='自然などの人間を超えた力に感謝の気持ちを持つことがある.')),
                ('crt_shk5', otree.db.models.StringField(choices=[('あてはまらない', 'あてはまらない'), ('どちらかといえばあてはまらない', 'どちらかといえばあてはまらない'), ('どちらかといえばあてはまる', 'どちらかといえばあてはまる'), ('あてはまる', 'あてはまる')], max_length=10000, null=True, verbose_name='自然などの人間を超えた力に恐れの気持ちを持つことがある. ')),
                ('crt_shk6', otree.db.models.StringField(choices=[('あてはまらない', 'あてはまらない'), ('どちらかといえばあてはまらない', 'どちらかといえばあてはまらない'), ('どちらかといえばあてはまる', 'どちらかといえばあてはまる'), ('あてはまる', 'あてはまる')], max_length=10000, null=True, verbose_name='自然などの人間を超えた力によって，生かされていると思うことがある. ')),
                ('crt_shk7', otree.db.models.StringField(choices=[('あてはまらない', 'あてはまらない'), ('どちらかといえばあてはまらない', 'どちらかといえばあてはまらない'), ('どちらかといえばあてはまる', 'どちらかといえばあてはまる'), ('あてはまる', 'あてはまる')], max_length=10000, null=True, verbose_name='自然は大切な存在である．')),
                ('crt_shk8', otree.db.models.StringField(choices=[('あてはまらない', 'あてはまらない'), ('どちらかといえばあてはまらない', 'どちらかといえばあてはまらない'), ('どちらかといえばあてはまる', 'どちらかといえばあてはまる'), ('あてはまる', 'あてはまる')], max_length=10000, null=True, verbose_name='「天罰」が存在すると思いますか？')),
                ('crt_shk9', otree.db.models.StringField(choices=[('あてはまらない', 'あてはまらない'), ('どちらかといえばあてはまらない', 'どちらかといえばあてはまらない'), ('どちらかといえばあてはまる', 'どちらかといえばあてはまる'), ('あてはまる', 'あてはまる')], max_length=10000, null=True, verbose_name='「天国」が存在すると思いますか？')),
                ('crt_shk10', otree.db.models.StringField(choices=[('あてはまらない', 'あてはまらない'), ('どちらかといえばあてはまらない', 'どちらかといえばあてはまらない'), ('どちらかといえばあてはまる', 'どちらかといえばあてはまる'), ('あてはまる', 'あてはまる')], max_length=10000, null=True, verbose_name='「地獄」が存在すると思いますか？')),
                ('crt_shk11', otree.db.models.StringField(choices=[('あてはまらない', 'あてはまらない'), ('どちらかといえばあてはまらない', 'どちらかといえばあてはまらない'), ('どちらかといえばあてはまる', 'どちらかといえばあてはまる'), ('あてはまる', 'あてはまる')], max_length=10000, null=True, verbose_name='「天罰」が存在すると思いますか？')),
                ('crt_shk12', otree.db.models.StringField(choices=[('仏教（系)', '仏教（系)'), ('神道（系)', '神道（系)'), ('プロテスタント（系)', 'プロテスタント（系)'), ('カトリック（系)', 'カトリック（系)'), ('ユダヤ教（系)', 'ユダヤ教（系)'), ('正教会（系)', '正教会（系)'), ('イスラム教（系)', 'イスラム教（系)'), ('その他宗教', 'その他宗教'), ('信仰していない', '信仰していない')], max_length=10000, null=True, verbose_name='あなたは何か宗教を信仰していますか？信仰していない方は「信仰していない」を選んでください．')),
                ('crt_shk13', otree.db.models.StringField(choices=[('1. 非常に熱心に信仰している', '1. 非常に熱心に信仰している'), ('2. 熱心に信仰している', '2. 熱心に信仰している'), ('3. 信仰している', '3. 信仰している'), ('4. ほとんど信仰していない', '4. ほとんど信仰していない'), ('5. 無宗教', '5. 無宗教')], max_length=10000, null=True, verbose_name='あなたはどの程度その宗教を熱心に信仰していますか．１（非常に強く信仰している）-4（ほとんど信仰していない）の4点満点でお答え下さい．なお，無宗教の方は"5（無宗教）"を選んで下さい．')),
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ind_info2.Group')),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ind_info2_player', to='otree.Participant')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ind_info2_player', to='otree.Session')),
            ],
            options={
                'db_table': 'ind_info2_player',
            },
            bases=(otree_save_the_change.mixins.SaveTheChange, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round_number', otree.db.models.PositiveIntegerField(db_index=True, null=True)),
                ('session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ind_info2_subsession', to='otree.Session')),
            ],
            options={
                'db_table': 'ind_info2_subsession',
            },
            bases=(otree_save_the_change.mixins.SaveTheChange, models.Model),
        ),
        migrations.AddField(
            model_name='player',
            name='subsession',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ind_info2.Subsession'),
        ),
        migrations.AddField(
            model_name='group',
            name='subsession',
