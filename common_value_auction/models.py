...
doc = """
この共通価値オークションゲームでは，プレイヤーはオークションにかけられている商品の購入を目指してもらいます．<br/>
競りの前に，実際のその商品の実際の価値が設定されます．その実際の価値は競りの後に提示されます．<br/>
競りは公開されません．最も高い価格を提示した人がオークションで勝つことになります．
しかし，実際の利得はその競り値と実際の価値に依拠します．
